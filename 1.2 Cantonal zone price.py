...
#Get the price of all the properties in the postal code area to make a distribution graph with it.
   def distribCanton(self, canton, varx):
       ...
       try:
           ...
           cursor.close()
           print('Postal codes taken into account for the Canton of ' + townName + ': ' +str(postalCodeList))
...
# Get the price and size of the flat in a certain postal code and plot it in a two dimensional graph.
   def priceMeterCanton(self, canton):
       list = []
       lista = []
       siza= []
       postalCodeList = cantonal(DBOperations("kezenihi_srmidb3")).cantonName(canton)
       ...
       try:
           ...
           cursor.close()
           print('Postal codes taken into account for the Canton of ' + townName + ': ' + str(postalCodeList))
           print('There are '+str(len(axis1))+' observations in Canton '+townName)
...
postalCodes = avgPcCanton(DBOperations("kezenihi_srmidb3"))
postalCodes.averageCanton('Genf', 'price', 'size')

postalCodes.distribCanton('Genf', 'price')
postalCodes.priceMeterCanton('Genf')
postalCodes.weatherCanton('Genf')

#hello=cantonal(DBOperations("kezenihi_srmidb3")).cantonName('Waadt')
#print(hello)
# --------------------------------------------------
